...
class Dispatcher(object):
    ...
    def request_switcher(self, json_message, session_id, config_params):
        ...
        try:
            ...
            switcher = {
                'get_if_data': RequestObj.get_if_data,
                'get_mac_table_dlink': RequestObj.get_mac_table_dlink,
                'get_mac_table_cisco': RequestObj.get_mac_table_cisco,
                'get_mac_table': RequestObj.get_mac_table,
                'get_ifnterface_map_table': RequestObj.get_ifnterface_map_table,
            }
